...
export default function DatingPage() {
  ...
  return (
    <DefaultLayout>
      <div className="flex absolute w-screen h-[90vh] p-8 z-0 items-end">
        <TinderStack profiles={data} onMatch={setMatchedProfile} />
      </div>
      <div className={cn("z-0 transition-all duration-1000 ease-in-out absolute w-screen flex items-center justify-center", isUserCollapsed ? "h-[10vh] bottom-0 p-8" : "h-screen p-8")}>
